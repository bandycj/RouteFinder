...
(function (a) {
    a.widget("mobile.datebox", a.mobile.widget, {options:{version:"2-1.1.0-2012061400", theme:false, themeDefault:"c", themeHeader:"a", mode:false, centerHoriz:false, centerVert:false, transition:"pop", useAnimation:true, hideInput:false, hideFixedToolbars:false, lockInput:true, enhanceInput:true, zindex:"500", clickEvent:"vclick", resizeListener:true, defaultValue:false, dialogEnable:false, dialogForce:false, useModal:false, useInline:false, useInlineBlind:false, useHeader:true, useImmediate:false, useButton:true, useFocus:false, useClearButton:false, useCollapsedBut:false, openCallback:false, openCallbackArgs:[], closeCallback:false, closeCallbackArgs:[], afterToday:false, beforeToday:false, notToday:false, maxDays:false, minDays:false, maxYear:false, minYear:false, blackDates:false, blackDays:false, minHour:false, maxHour:false, minuteStep:1, minuteStepRound:0, rolloverMode:{m:true, d:true, h:true, i:true, s:true}, useLang:"default", lang:{"default":{setDateButtonLabel:"Set Date", setTimeButtonLabel:"Set Time", setDurationButtonLabel:"Set Duration", calTodayButtonLabel:"Jump to Today", titleDateDialogLabel:"Set Date", titleTimeDialogLabel:"Set Time", daysOfWeek:["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"], daysOfWeekShort:["Su", "Mo", "Tu", "We", "Th", "Fr", "Sa"], monthsOfYear:["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"], monthsOfYearShort:["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"], durationLabel:["Days", "Hours", "Minutes", "Seconds"], durationDays:["Day", "Days"], timeFormat:24, headerFormat:"%A, %B %-d, %Y", tooltip:"Open Date Picker", nextMonth:"Next Month", prevMonth:"Previous Month", dateFieldOrder:["m", "d", "y"], timeFieldOrder:["h", "i", "a"], slideFieldOrder:["y", "m", "d"], dateFormat:"%Y-%m-%d", useArabicIndic:false, isRTL:false, calStartDay:0, clearButton:"Clear", durationOrder:["d", "h", "i", "s"], meridiem:["AM", "PM"], timeOutput:"%k:%M", durationFormat:"%Dd %DA, %Dl:%DM:%DS"}}}, _enhanceDate:function () {
        a.extend(this._date.prototype, {copy:function (c, b) {
            ...
            this.set(2, 1).adj(2, (b - this.getDay()));
            if (this.get(2) > 10) {
                this.adj(2, 7)
            }
            return this
        }, setWeek:function (c, b) {
            if (c === 4) {
                return this.set(1, 0).set(2, 1).setFirstDay(4).adj(2, -3).adj(2, (b - 1) * 7)
            }
            ...
            switch (c) {
                ...
                case 4:
                    ...
                    b = Math.floor((this.getTime() - d.getTime()) / 604800000) + 1;
                    if (b < 1) {
        ...
        if (typeof c[c.mode + "lang"][d] !== "undefined") {
        ...
        if (c.mode === "durationbox") {
            e = e.replace(/%D([a-z])/gi, function (d, i) {
                switch (i) {
                    case"d":
                    case"l":
                    case"M":
        ...
        e = e.replace(/%(0|-)*([a-z])/gi, function (d, i, o) {
            h.push(o);
            switch (o) {
                case"p":
                case"P":
        ...
        if (m === null || m.length !== l.length) {
            ...
            f = new n._date(n._n(j.year, 1), n._n(j.mont, 1), n._n(j.date, 1), n._n(j.hour, 0), n._n(j.mins, 0), n._n(j.secs, 0), 0);
            ...
            if (j.week !== false) {
                f.setWeek(j.wtyp, j.week);
                if (j.date > -1) {
                    f.setDate(j.date)
                }
            }
            if (j.yday !== false) {
                f.set(1, 0).set(2, 1).adj(2, (j.yday - 1))
            }
            if (j.wday !== false) {
        ...
        f = f.replace(/%(D|X|0|-)*([a-zA-Z])/g, function (h, i, j) {
            if (i === "X") {
                if (typeof b._customformat[g.mode] !== "undefined") {
                    return b._customformat[g.mode](j, c)
                }
                return h
            }
            if (i === "D") {
            ...
            switch (j) {
                ...
                case"d":
                    return((i === "-") ? c.getDate() : b._zPad(c.getDate()));
                case"H":
                case"k":
                    return((i === "-") ? c.getHours() : b._zPad(c.getHours()));
                case"I":
                case"l":
                    return((i === "-") ? ((c.getHours() === 0 || c.getHours() === 12) ? 12 : ((c.getHours() < 12) ? c.getHours() : (c.getHours() - 12))) : b._zPad(((c.getHours() === 0 || c.getHours() === 12) ? 12 : ((c.getHours() < 12) ? c.getHours() : c.getHours() - 12))));
                case"m":
                    return((i === "-") ? c.getMonth() + 1 : b._zPad(c.getMonth() + 1));
                case"M":
                    return((i === "-") ? c.getMinutes() : b._zPad(c.getMinutes()));
                case"p":
                ...
                case"s":
                    return c.getEpoch();
                case"S":
                    return((i === "-") ? c.getSeconds() : b._zPad(c.getSeconds()));
                case"u":
                    return((i === "-") ? c.getDay() + 1 : b._zPad(c.getDay() + 1));
                case"w":
                    return c.getDay();
                case"y":
                ...
                case"V":
                    return((i === "-") ? c.getWeek(4) : b._zPad(c.getWeek(4)));
                case"U":
                    return((i === "-") ? c.getWeek(0) : b._zPad(c.getWeek(0)));
                case"W":
                    return((i === "-") ? c.getWeek(1) : b._zPad(c.getWeek(1)));
                case"o":
                ...
                case"G":
                    if (c.getWeek(4) === 1 && c.getMonth() > 0) {
                        return c.getFullYear() + 1
                    }
                    if (c.getWeek(4) > 51 && c.getMonth() < 11) {
                        return c.getFullYear() - 1
                    }
                    return c.getFullYear();
                case"g":
        ...
        b._enhanceDate();
        b.theDate = new Date();
        b.initDate = b.theDate.copy();
        b.initDone = false;
        if (i.useButton === true && i.useInline === false) {
            b.d.open = a('<a href="#" class="ui-input-clear" title="' + this.__("tooltip") + '">' + this.__("tooltip") + "</a>").on(i.clickEvent,function (d) {
                d.preventDefault();
                if (!b.disabled) {
                    b.d.input.trigger("datebox", {method:"open"});
        ...
        b.d.screen = a("<div>", {"class":"ui-datebox-screen ui-datebox-hidden" + ((i.useModal) ? " ui-datebox-screen-modal" : "")}).css({"z-index":i.zindex - 1}).on(i.clickEvent, function (d) {
            d.preventDefault();
            b.d.input.trigger("datebox", {method:"close"})
        });
        if (i.enhanceInput === true && navigator.userAgent.match(/Android|iPhone|iPad/i)) {
            b.inputType = "number"
        } else {
            b.inputType = "text"
        }
        ...
        b.d.wrap.on(i.clickEvent, function () {
            if (!b.disabled && (i.noButtonFocusMode || i.focusMode)) {
                b.d.input.trigger("datebox", {method:"open"});
                b.d.wrap.addClass("ui-focus");
                b.d.input.removeClass("ui-focus")
            }
        });
        b.d.input.removeClass("ui-corner-all ui-shadow-inset").focus(function () {
            if (b.disabled === false && i.useFocus === true) {
                b.d.input.trigger("datebox", {method:"open"});
                b.d.wrap.addClass("ui-focus")
            }
            b.d.input.removeClass("ui-focus")
                    ...
                    b.refresh()
                }).attr("readonly", i.lockInput).on("datebox", b._event);
        if (typeof a.event.special.mousewheel !== "undefined") {
            b.wheelExists = true
        }
        if (b.d.input.is(":disabled")) {
            b.disable()
        }
        if (i.useInline === true || i.useInlineBlind) {
            b.open()
        }
        ...
        var b = h.widget, i = h.widget.options, f = {h:a.mobile.activePage.find(".ui-header").jqmData("position"), f:a.mobile.activePage.find(".ui-footer").jqmData("position"), fh:a.mobile.activePage.find(".ui-footer").outerHeight(), hh:a.mobile.activePage.find(".ui-header").outerHeight()}, c = {x:b.d.wrap.offset().left + (b.d.wrap.outerWidth() / 2), y:b.d.wrap.offset().top + (b.d.wrap.outerHeight() / 2)}, d = {w:b.d.mainWrap.outerWidth(), h:b.d.mainWrap.outerHeight()}, g = {t:a(window).scrollTop(), h:a(window).height(), w:a.mobile.activePage.width(), ah:a(document).height()}, j = {y:(i.centerVert) ? g.t + ((g.h / 2) - (d.h / 2)) : c.y - (d.h / 2), x:(g.w < 400 || i.centerHoriz) ? (g.w / 2) - (d.w / 2) : c.x - (d.w / 2)};
        if (i.centerVert === false) {
            if (i.hideFixedToolbars === true && (typeof f.f !== "undefined" || typeof f.h !== "undefined")) {
                a.mobile.activePage.find(":jqmData(position='fixed')").fixedtoolbar("hide");
                f.f = undefined;
                f.h = undefined
            }
            if (typeof f.f !== "undefined") {
                if ((j.y + d.h) > (g.h - f.fh - 2)) {
                    j.y = g.h - f.fh - 2 - d.h
                }
            } else {
                if ((j.y + d.h) > (g.ah - f.fh - 2)) {
                    j.y = g.ah - f.fh - 2 - d.h
                }
                if ((g.h + g.t) < (d.h + j.y + 2)) {
                    j.y = g.h + g.t - d.h - 2
                }
            }
        ...
        b.d.mainWrap.css({position:"absolute", top:j.y, left:j.x})
    }, _drag:{"default":function () {
        return false
    }}, open:function () {
        var b = this, e = this.options, d = "data-" + this.ns, c = e.useAnimation ? e.transition : "none";
        if (e.useFocus === true && b.fastReopen === true) {
            b.d.input.blur();
            return false
        }
        ...
        if (e.openCallback !== false) {
            if (!a.isFunction(e.openCallback)) {
                if (typeof window[e.openCallback] !== "undefined") {
                    e.openCallback = window[e.openCallback]
                } else {
                    e.openCallback = new Function(e.openCallback)
                }
            }
            if (e.openCallback.apply(b, a.merge([b.theDate], e.openCallbackArgs)) === false) {
                return false
            }
        }
        b.theDate = b._makeDate(b.d.input.val());
        b.d.input.blur();
        if (typeof b._build[e.mode] === "undefined") {
            b._build["default"].apply(b, [])
        } else {
            b._build[e.mode].apply(b, [])
        }
        if (typeof b._drag[e.mode] !== "undefined") {
            b._drag[e.mode].apply(b, [])
        }
        b.d.input.trigger("datebox", {method:"refresh"});
        if (b.__("useArabicIndic") === true) {
            b._doIndic()
        }
        if ((e.useInline === true || e.useInlineBlind === true) && b.initDone === false) {
        ...
        if (e.dialogForce || (e.dialogEnable && window.width() < 400)) {
            b.d.dialogPage = a("<div " + d + "role='dialog' " + d + "theme='" + e.theme + "' ><div " + d + "role='header' " + d + "theme='" + e.themeHeader + "'><h1>" + b.d.headerText + "</h1></div><div " + d + "role='content'></div>").appendTo(a.mobile.pageContainer).page().css("minHeight", "0px").addClass(c);
            b.d.dialogPage.find(".ui-header").find("a").off("click vclick").on(e.clickEvent, function (f) {
                f.preventDefault();
                b.d.input.trigger("datebox", {method:"close"})
            });
            ...
            b.d.mainWrap.empty();
            if (e.useHeader === true) {
                b.d.headHTML = a('<div class="ui-header ui-bar-' + e.themeHeader + '"></div>');
                a("<a class='ui-btn-left' href='#'>Close</a>").appendTo(b.d.headHTML).buttonMarkup({theme:e.themeHeader, icon:"delete", iconpos:"notext", corners:true, shadow:true}).on(e.clickEvent, function (f) {
                    f.preventDefault();
                    b.d.input.trigger("datebox", {method:"close"})
                });
            ...
            b.d.mainWrap.append(b.d.intHTML).css("zIndex", e.zindex);
            ...
            a(document).on("orientationchange.datebox", {widget:b}, function (f) {
                b._applyCoords(f.data)
            });
            if (e.resizeListener === true) {
                a(window).on("resize.datebox", {widget:b}, function (f) {
                    b._applyCoords(f.data)
                })
            }
        }
        ...
        if (b.d.dialogPage !== false) {
            ...
            if (!a.mobile.activePage.jqmData("page").options.domCache) {
        ...
        if (a.inArray(c.mode, ["timebox", "durationbox", "timeflipbox"]) > -1) {
    ...
    a.extend(a.mobile.datebox.prototype.options, {themeDateToday:"a", themeDayHigh:"e", themeDatePick:"a", themeDateHigh:"e", themeDateHighAlt:"e", themeDate:"d", calHighToday:true, calHighPick:true, calShowDays:true, calOnlyMonth:false, calWeekMode:false, calWeekModeDay:1, calWeekHigh:false, calControlGroup:false, calShowWeek:false, useTodayButton:false, useCollapsedBut:false, highDays:false, highDates:false, highDatesAlt:false, enableDates:false});
    a.extend(a.mobile.datebox.prototype, {_cal_gen:function (d, f, l, i, h) {
        ...
        var b = this, i = this.options, d = {}, c = new this._date(f, g, e, 0, 0, 0, 0).getDay();
        d.ok = true;
        d.iso = f + "-" + b._zPad(g + 1) + "-" + b._zPad(e);
        d.comp = parseInt(d.iso.replace(/-/g, ""), 10);
        d.theme = i.themeDate;
        if (a.isArray(i.enableDates) && a.inArray(d.iso, i.enableDates) < 0) {
            d.ok = false
        } else {
            if (h.checkDates) {
                if ((i.afterToday === true && h.thisDate.comp() > d.comp) || (i.beforeToday === true && h.thisDate.comp() < d.comp) || (i.notToday === true && h.thisDate.comp() === d.comp) || (i.maxDays !== false && h.maxDate.comp() < d.comp) || (i.minDays !== false && h.minDate.comp() > d.comp) || (a.isArray(i.blackDays) && a.inArray(c, i.blackDays) > -1) || (a.isArray(i.blackDates) && a.inArray(d.iso, i.blackDates) > -1)) {
                    d.ok = false
                }
            }
        }
        if (d.ok) {
            if (i.calHighPick && e === h.presetDay) {
                ...
                if (i.calHighToday && d.comp === h.thisDate.comp()) {
                    d.theme = i.themeDateToday
                } else {
                    if (a.isArray(i.highDatesAlt) && (a.inArray(d.iso, i.highDatesAlt) > -1)) {
                        d.theme = i.themeDateHighAlt
                    } else {
                        if (a.isArray(i.highDates) && (a.inArray(d.iso, i.highDates) > -1)) {
                            d.theme = i.themeDateHigh
                        } else {
                            if (a.isArray(i.highDays) && (a.inArray(c, i.highDays) > -1)) {
    ...
    a.extend(a.mobile.datebox.prototype._build, {calbox:function () {
        var h = this, c = this.options, e, b = false, f = "ui-datebox-", k = false, l = false, d = false, j = false, g = false;
        if (typeof h.d.intHTML !== "boolean") {
            h.d.intHTML.remove()
        }
        h.d.headerText = ((h._grabLabel() !== false) ? h._grabLabel() : h.__("titleDateDialogLabel"));
        h.d.intHTML = a("<span>");
        a('<div class="' + f + 'gridheader"><div class="' + f + 'gridlabel"><h4>' + h.__("monthsOfYear")[h.theDate.getMonth()] + " " + h.theDate.getFullYear() + "</h4></div></div>").appendTo(h.d.intHTML);
        a("<div class='" + f + "gridplus" + (h.__("isRTL") ? "-rtl" : "") + "'><a href='#'>" + h.__("nextMonth") + "</a></div>").prependTo(h.d.intHTML.find("." + f + "gridheader")).buttonMarkup({theme:c.themeDate, icon:"plus", inline:true, iconpos:"notext", corners:true, shadow:true}).on(c.clickEvent, function (i) {
            i.preventDefault();
            if (h.calNext) {
                if (h.theDate.getDate() > 28) {
                    h.theDate.setDate(1)
                }
                h._offset("m", 1)
            }
        });
        a("<div class='" + f + "gridminus" + (h.__("isRTL") ? "-rtl" : "") + "'><a href='#'>" + h.__("prevMonth") + "</a></div>").prependTo(h.d.intHTML.find("." + f + "gridheader")).buttonMarkup({theme:c.themeDate, icon:"minus", inline:true, iconpos:"notext", corners:true, shadow:true}).on(c.clickEvent, function (i) {
            i.preventDefault();
            if (h.calPrev) {
                if (h.theDate.getDate() > 28) {
                    h.theDate.setDate(1)
        ...
        b = {today:-1, highlightDay:-1, presetDay:-1, startDay:h.__("calStartDay"), thisDate:new h._date(), maxDate:new h._date(), minDate:new h._date(), currentMonth:false, weekMode:0, weekDays:null};
        b.start = (h.theDate.copy([0], [0, 0, 1]).getDay() - h.__("calStartDay") + 7) % 7;
        b.thisMonth = h.theDate.getMonth();
        b.wk = h.theDate.copy([0], [0, 0, 1]).adj(2, (-1 * b.start) + (h.__("calStartDay") === 0 ? 1 : 0)).getWeek(4);
        b.end = 32 - h.theDate.copy([0], [0, 0, 32, 13]).getDate();
        b.lastend = 32 - h.theDate.copy([0, -1], [0, 0, 32, 13]).getDate();
        b.presetDate = h._makeDate(h.d.input.val());
        b.thisDateArr = b.thisDate.getArray();
        b.theDateArr = h.theDate.getArray();
        ...
        if (b.presetDate.comp() === h.theDate.comp()) {
        ...
        k = a('<div class="' + f + 'grid">').appendTo(h.d.intHTML);
        if (c.calShowDays) {
            h._cal_days = h.__("daysOfWeekShort").concat(h.__("daysOfWeekShort"));
            b.weekDays = a("<div>", {"class":f + "gridrow"}).appendTo(k);
            if (h.__("isRTL") === true) {
            ...
            for (e = 0; e <= 6; e++) {
                a("<div>" + h._cal_days[(e + b.startDay) % 7] + "</div>").addClass(f + "griddate " + f + "griddate-empty " + f + "griddate-label").appendTo(b.weekDays)
            }
        }
        b.gen = h._cal_gen(b.start, b.lastend, b.end, !c.calOnlyMonth, h.theDate.getMonth());
        for (l in b.gen) {
            j = a("<div>", {"class":f + "gridrow"});
            if (h.__("isRTL")) {
                j.css("direction", "rtl")
            }
            if (c.calShowWeek) {
                a("<div>", {"class":f + "griddate " + f + "griddate-empty"}).text("W" + b.wk).appendTo(j);
                b.wk++;
                if (b.wk > 52 && typeof b.gen[parseInt(l, 10) + 1] !== "undefined") {
                    b.wk = new Date(b.theDateArr[0], b.theDateArr[1], ((h.__("calStartDay") === 0) ? b.gen[parseInt(l, 10) + 1][1][0] : b.gen[parseInt(l, 10) + 1][0][0])).getWeek(4)
                }
            }
            for (d in b.gen[l]) {
                if (c.calWeekMode) {
                    b.weekMode = b.gen[l][c.calWeekModeDay][0]
                }
                if (typeof b.gen[l][d] === "boolean") {
                    a("<div>", {"class":f + "griddate " + f + "griddate-empty"}).appendTo(j)
                } else {
                    g = h._cal_check(b, b.theDateArr[0], b.gen[l][d][1], b.gen[l][d][0]);
                    if (b.gen[l][d][0]) {
                        a("<div>" + String(b.gen[l][d][0]) + "</div>").addClass(b.thisMonth === b.gen[l][d][1] ? (f + "griddate ui-corner-all ui-btn-up-" + g.theme + (g.ok ? "" : " " + f + "griddate-disable")) : (f + "griddate " + f + "griddate-empty")).jqmData("date", ((c.calWeekMode) ? b.weekMode : b.gen[l][d][0])).jqmData("theme", b.thisMonth === b.gen[l][d][1] ? g.theme : "-").jqmData("enabled", g.ok).jqmData("month", b.gen[l][d][1]).appendTo(j)
                    }
                }
            }
            if (c.calControlGroup === true) {
                j.find(".ui-corner-all").removeClass("ui-corner-all").eq(0).addClass("ui-corner-left").end().last().addClass("ui-corner-right").addClass("ui-controlgroup-last")
            }
            j.appendTo(k)
        }
        if (c.calShowWeek) {
            k.find("." + f + "griddate").addClass(f + "griddate-week")
        }
        if (c.useTodayButton || c.useClearButton) {
            j = a("<div>", {"class":f + "controls"});
            if (c.useTodayButton) {
                a('<a href="#">' + h.__("calTodayButtonLabel") + "</a>").appendTo(j).buttonMarkup({theme:c.theme, icon:"check", iconpos:"left", corners:true, shadow:true}).on(c.clickEvent, function (i) {
                    i.preventDefault();
                    h.theDate = new h._date();
                    h.theDate = new h._date(h.theDate.getFullYear(), h.theDate.getMonth(), h.theDate.getDate(), 0, 0, 0, 0);
                    h.d.input.trigger("datebox", {method:"doset"})
                })
            }
            if (c.useClearButton) {
                a('<a href="#">' + h.__("clearButton") + "</a>").appendTo(j).buttonMarkup({theme:c.theme, icon:"delete", iconpos:"left", corners:true, shadow:true}).on(c.clickEvent, function (i) {
                    i.preventDefault();
                    h.d.input.val("");
                    h.d.input.trigger("datebox", {method:"clear"});
                    h.d.input.trigger("datebox", {method:"close"})
                })
            }
        ...
        h.d.intHTML.on(c.clickEvent + " vmouseover vmouseout", "div." + f + "griddate", function (i) {
            if (i.type === c.clickEvent) {
                i.preventDefault();
                if (a(this).jqmData("enabled")) {
                    h.theDate.set(2, 1).set(1, a(this).jqmData("month")).set(2, a(this).jqmData("date"));
                    h.d.input.trigger("datebox", {method:"set", value:h._formatter(h.__fmt(), h.theDate), date:h.theDate});
                    h.d.input.trigger("datebox", {method:"close"})
                }
            } else {
                if (a(this).jqmData("enabled") && typeof a(this).jqmData("theme") !== "undefined") {
        ...
        h.d.intHTML.on("swipeleft",function () {
            if (h.calNext) {
                h._offset("m", 1)
            }
        ...
        if (h.wheelExists) {
            h.d.intHTML.on("mousewheel", function (i, m) {
                i.preventDefault();
                if (m > 0 && h.calNext) {
                    h.theDate.set(2, 1);
                    h._offset("m", 1)
